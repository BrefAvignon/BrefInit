...
{	# load and normalize the data as strings
	...
	{	# merge rows considered as compatible
		...
		data <- fix.mdtfct.dates(data, election.file, series.file, type, strict=FALSE)
	}
